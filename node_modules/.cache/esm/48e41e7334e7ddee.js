let doctrine,parser,YAML,hasEmptyProperty,convertGlobPaths,extractAnnotations,extractYamlFromJsDoc,isTagPresentInTags;_34e‍.x([["prepare",()=>prepare],["format",()=>format],["clean",()=>clean],["finalize",()=>finalize],["organize",()=>organize],["extract",()=>extract]]);_34e‍.w("doctrine",[["default",["doctrine"],function(v){doctrine=v}]]);_34e‍.w("swagger-parser",[["default",["parser"],function(v){parser=v}]]);_34e‍.w("yaml",[["default",["YAML"],function(v){YAML=v}]]);_34e‍.w("./utils.js",[["hasEmptyProperty",["hasEmptyProperty"],function(v){hasEmptyProperty=v}],["convertGlobPaths",["convertGlobPaths"],function(v){convertGlobPaths=v}],["extractAnnotations",["extractAnnotations"],function(v){extractAnnotations=v}],["extractYamlFromJsDoc",["extractYamlFromJsDoc"],function(v){extractYamlFromJsDoc=v}],["isTagPresentInTags",["isTagPresentInTags"],function(v){isTagPresentInTags=v}]]);
 ...
 * @returns {object} swaggerObject
 */
       function organize(swaggerObject, annotations) {
