let fs,extname,glob;_34e‍.x([["convertGlobPaths",()=>convertGlobPaths],["hasEmptyProperty",()=>hasEmptyProperty],["extractYamlFromJsDoc",()=>extractYamlFromJsDoc],["extractAnnotations",()=>extractAnnotations],["isTagPresentInTags",()=>isTagPresentInTags],["validateOptions",()=>validateOptions]]);_34e‍.w("fs",[["promises",["fs"],function(v){fs=v}]]);_34e‍.w("path",[["extname",["extname"],function(v){extname=v}]]);_34e‍.w("glob",[["default",["glob"],function(v){glob=v}]]);
 ...
 */
       async function extractAnnotations(filePath, encoding = 'utf8') {
